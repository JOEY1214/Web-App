...
$contact_edit = get_contact($_GET['i']);
if (is_null($contact_edit)) {
    //如果文章是null就轉回列表頁
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo $contact_edit['name']; ?></h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-12">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form id="edit_contacts_form" role="form">
                                    <input type="hidden" id="id" value="<?php echo $contact_edit['id']; ?>">
                                    <div class="form-group">
                                        <h4>Name(Staff):</h4>
                                        <input id="name" class="form-control"
                                               value="<?php echo $contact_edit['name']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="identity" class="form-control"
                                               value="<?php echo $contact_edit['identity']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <h4>Office address(Staff):</h4>
                                        <input id="office" class="form-control"
                                               value="<?php echo $contact_edit['office_address']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <h4>Phone(Staff):</h4>
                                        <input id="phone" class="form-control"
                                               value="<?php echo $contact_edit['phone']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <h4>Email(Staff):</h4>
                                        <input id="email" class="form-control"
                                               value="<?php echo $contact_edit['email']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <h4>Title of department:</h4>
                                        <input id="department" class="form-control"
                                               value="<?php echo $contact_edit['department']; ?>">
                                    </div>
                                    <div class="form-group" id="editor">
                                        <h4>Functions:</h4>
                                        <textarea id="content">
                                            <?php echo $contact_edit['function']; ?>
                                        </textarea>
                                    </div>
                                    <br>
...
<script>
    $(document).ready(function () {
        ...
        <!-- Post JavaScript -->
        $("#edit_contacts_form").on("submit", function () {
            //加入loading icon
            ...
            if ($("#title").val() == '' || $("#content").val() == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "../php/update_contact.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
                    data: {
                        id:$("#id").val(),
                        name: $("#name").val(), //使用者帳號
